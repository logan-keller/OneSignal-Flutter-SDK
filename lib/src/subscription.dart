...
class OSSubscriptionStateChanges extends JSONStringRepresentable {
  ...
  String jsonRepresentation() {
    return convertToJsonString(<String, dynamic>{'from': from.jsonRepresentation(), 'to': to.jsonRepresentation()});
  }
}
...
class OSEmailSubscriptionState extends JSONStringRepresentable {
  ...
  String jsonRepresentation() {
    return convertToJsonString(
        {'subscribed': this.subscribed, 'emailUserId': this.emailUserId, 'emailAddress': this.emailAddress});
  }
}
...
class OSEmailSubscriptionStateChanges extends JSONStringRepresentable {
  ...
  OSEmailSubscriptionStateChanges(Map<String, dynamic> json) {
    if (json.containsKey('from')) this.from = OSEmailSubscriptionState(json['from'].cast<String, dynamic>());
    if (json.containsKey('to')) this.to = OSEmailSubscriptionState(json['to'].cast<String, dynamic>());
  }

  String jsonRepresentation() {
    return convertToJsonString(
        <String, dynamic>{'from': this.from.jsonRepresentation(), 'to': this.to.jsonRepresentation()});
  }
}
...
class OSSMSSubscriptionState extends JSONStringRepresentable {
  ...
  OSSMSSubscriptionState(Map<String, dynamic> json) {
    this.subscribed = false;
    if (json.containsKey('smsNumber') && json['smsNumber'] != null) this.smsNumber = json['smsNumber'] as String;
  ...
  String jsonRepresentation() {
    return convertToJsonString(
        {'subscribed': this.subscribed, 'smsUserId': this.smsUserId, 'smsNumber': this.smsNumber});
  }
}
...
class OSSMSSubscriptionStateChanges extends JSONStringRepresentable {
  OSSMSSubscriptionState from;
  OSSMSSubscriptionState to;

  OSSMSSubscriptionStateChanges(Map<String, dynamic> json) {
    if (json.containsKey('from')) this.from = OSSMSSubscriptionState(json['from'].cast<String, dynamic>());
    if (json.containsKey('to')) this.to = OSSMSSubscriptionState(json['to'].cast<String, dynamic>());
  }
