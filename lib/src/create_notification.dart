...
class OSCreateNotification extends JSONStringRepresentable {
  ...
  OSCreateNotification.silentNotification(
      {@required this.playerIds, this.additionalData, this.sendAfter, this.delayedOption, this.deliveryTimeOfDay}) {
  ...
  Map<String, dynamic> mapRepresentation() {
    ...
    if (this.delayedOption != null) json['delayed_option'] = convertEnumCaseToValue(this.delayedOption);
