  ...
  OSNotification(Map<String, dynamic> json) {
    ...
    if (json.containsKey('backgroundImageLayout')) {
      this.backgroundImageLayout =
          OSAndroidBackgroundImageLayout(json['backgroundImageLayout'].cast<String, dynamic>());
    }
...
class OSNotificationAction {
  ...
  OSNotificationAction(Map<String, dynamic> json) {
    ...
    if (json.containsKey('type')) this.type = OSNotificationActionType.values[json['type'] as int];
  }
}
...
class OSAndroidBackgroundImageLayout extends JSONStringRepresentable {
  ...
  String jsonRepresentation() {
    return convertToJsonString(
        {'image': this.image, 'titleTextColor': this.titleTextColor, 'bodyTextColor': this.bodyTextColor});
  }
}
...
class OSNotificationReceivedEvent extends JSONStringRepresentable {
  ...
  String jsonRepresentation() {
    return convertToJsonString({'notification': this.notification.jsonRepresentation()});
  }
}
